...
if("TRUE" STREQUAL "TRUE")
  set(pathfinder_SOURCE_PREFIX /home/chaoz/SAEAuto_ROS/src/pathfinder)
  set(pathfinder_DEVEL_PREFIX /home/chaoz/SAEAuto_ROS/src/pathfinder/cmake-build-debug/devel)
  ...
  set(pathfinder_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Chao Zhang <Zhang@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pathfinder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chaoz/SAEAuto_ROS/src/pathfinder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chaoz/SAEAuto_ROS/src/pathfinder/cmake-build-debug/devel/lib;/home/chaoz/SAEAuto_ROS/devel/lib;/home/chaoz/vision_ws/devel/lib;/opt/ros/kinetic/lib)
